...
void InfoPanel::updateLabels()
{
    ...
    m_artistText->setText(fm.elidedText(m_metadata["Artist"], Qt::ElideRight, m_artistText->size().width()));
    m_albumText->setText(fm.elidedText(m_metadata["Album"], Qt::ElideRight, m_artistText->size().width()));
    m_titleText->setText(fm.elidedText(m_metadata["Title"], Qt::ElideRight, m_artistText->size().width()));
